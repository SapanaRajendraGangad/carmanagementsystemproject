 ...
 <div class=button style="display:inline">
  ...
  <div class="dropdown-menu" aria-labelledby="employeeMultiSelectDropdown">
    ...
    <button type="button" id="employeeSubmitBtn" class="btn btn-primary">Submit</button>
        ...
        <br><br>
        <a href="#" onclick="fetchData(getSearchParams()),showServiceTable(); return false;"><input type="button" value="Search" class="submit"/></a><br><br>
        <input type="button" value="View" class="submit" onclick="showServiceTable()"/><br><br>
  ...
  <table class="table" id="serviceData" style="display:none">
  <thead>
    <tr>
...
<tbody class="">
  <tr>
    <td><input type="checkbox" name="sid" value="<%=obj[4]%>"></td>
