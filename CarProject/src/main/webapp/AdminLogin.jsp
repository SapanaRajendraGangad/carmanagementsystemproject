    ...
    <div class="container-fluid heading">
        ...
        <div class="row">
            ...
            <b><ul>
                ...
                <li><a href="AdminLogin.jsp">Login Panel</a></li>
                ...
                <div class="login-container">
                    <div class="login-form">
                        <div class="logo-container">
                            <img src="img/icon-symbol-png.webp" alt="Graduation Cap" class="logo">
                        </div>
                       ...
                       <form action="login">
                            ...
                            <p class="register" style="text-align: center;">Not registered? <a href="#">Create an account</a></p>
                        </form>
                    </div>
                </div>
            </div>            
