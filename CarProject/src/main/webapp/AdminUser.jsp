...
<body>
    <div class="container-fluid heading">
        <div class="row">
            ...
            <b><ul>
              ...
              <li><a href="loginPanel.html">Login Panel</a></li>
        ...
        <div class="row">
            <div class="col-md-5 content">
                <ion-icon name="person-add-outline" style="font-size: 80px;border-radius:250px; margin-left:  310px; background: white; background: red; color: white; padding: 10px;"></ion-icon><br>
               <br><a href="AdminLogin.jsp" style="width:40%; height: 20%; font-size: 25px; margin-left: 250px;"><input type="button" value="Admin Login"  style="width:40%; height: 20%;"></a><br><br>
            <br>   <ion-icon name="people-outline" style="font-size: 80px;margin-top: 10px; margin-left:310px; border-radius:250px; background: red;color: white;padding: 10px;"></ion-icon><br><br><a href="UserLogin.jsp" style="width:40%; height: 20%; font-size: 25px; margin-left: 250px;"><input type="button" value="User Login"  style="width:40%; height: 20%;"></a>
            </div>
    ...
    <div class="container-fluid services1" id="services">
    <div class="row">
        <div class="col-md-12">
...
<footer class="text-center text-lg-start bg-body-tertiary text-muted" id="footer5">
    <div class="icon1">
   ...
   <section class="main-section">
      <div class="container text-center text-md-start mt-3 bg-light text-dark">
         <div class="row">
