...
<form id="PartForm" class="Form" action="" method="Get">
 <h3>Customer Details</h3>
    ...
    <br><br>
        <a href="ViewSearchPart.jsp?p=" onclick="fetchData(); return false;"><input type="button" value="Search" class="submit"/></a><br><br>
        <input type="button" value="View" class="submit" onclick="showPartTable()"/><br><br>
